...
function AdminSignup({ navigation }) {
    return (
        ...
        <ScrollView style={{ flex: 1, backgroundColor: "#ffffff" }} >
            <View style={{}}>
            <WavyHeader firstTxt={"Admin"} secTxt={"Account"} navigation={navigation} />
            </View>
            ...
            <View style={{ marginTop: normalize(21) }}>
                <Submitbutton bg={"#ffffff"} text={"Log in"} txtclr={"#f69632"} onpress={() => navigation.navigate("AdminScreen")} big={true} />
            </View>
        </ScrollView>
    )
}
