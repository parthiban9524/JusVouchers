...
export default function GraphSales() {
    return (
        ...
        <View style={{ alignSelf: "center", marginTop: normalize(40), elevation: normalize(5), shadowColor: "#000000", backgroundColor : "white", borderRadius : normalize(10) }}>
                <View style={{flexDirection:"row", justifyContent:'space-between'}}><Text style={{ fontSize: normalize(20), fontWeight: 'bold', color: "black", marginLeft : normalize(10), marginTop : normalize(10) }}>Sales</Text>
